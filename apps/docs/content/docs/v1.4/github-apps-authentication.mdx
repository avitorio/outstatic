...
Then you only need to follow the [Getting Started Guide](/v1.4/getting-started) to configure your application with the GitHub Apps **Client ID** and **Client Secret** values.
