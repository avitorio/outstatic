...
You can get started by visiting our [Getting started](/v1.4/getting-started) section. If you want to learn a bit more about Outstatic, keep reading.
...
But you are not limited to the above, you can also add [Custom Fields](/v1.4/custom-fields) to your documents.

Next: the [Content Editor](/v1.4/the-content-editor), which is used to edit Documents.
