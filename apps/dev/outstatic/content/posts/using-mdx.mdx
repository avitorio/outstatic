...
For components you reach for often, the [Block Library](https://outstatic.com/docs/block-library) lets you register reusable MDX blocks that appear in the slash command menu. Each block defines a component name, the props editors fill in, and any imports it needs — so inserting a block becomes a single click instead of hand-writing JSX.
