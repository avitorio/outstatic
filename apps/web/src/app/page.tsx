...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-2 max-w-screen overflow-hidden">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center text-center text-slate-800 mt-5 md:mt-10">
        <Link
        ...
        >
          ...
          ></div>
          <span className="inline">Introducing Custom Fields</span>
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
