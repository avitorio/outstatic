...
We've made it easy for you to fetch the data and content you create with Outstatic by providing simple functions and APIs. You should use these on the front end of your Next.js website. They can be used as async functions in the `/app` directory or inside of `getStaticProps` on the `/pages` directory.
