...
We recommend you learn how Outstatic [manages content](/what-is-outstatic) and also how to [fetch data](/access-integration/fetching-data) from your front end.
